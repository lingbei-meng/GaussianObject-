...
if __name__=="__main__":
    ...
    ratio = 0.6
    num_points_to_remove = int(ratio * num_points)
    ...
    # save the pointcloud
    if args.sparse_id >= 0:
        o3d.io.write_point_cloud(os.path.join(args.data_dir, f"visual_hull_mask_{str(ratio)}_{str(args.sparse_id)}.ply"), pcd)
    else:
